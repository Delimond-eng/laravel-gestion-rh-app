                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12 col-sm-12">
                            <label for="matricule" class="form-label">Libellé direction<sup class="text-danger">*</sup> </label>
                            <input type="text" name="libelle" class="form-control" id="libelle" placeholder="Saisir le libellé de la direction..." required>
                        </div>
