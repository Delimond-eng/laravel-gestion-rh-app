...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Rotation</h1>
            ...
            <div class="col-md-4">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-sm-12 mt-2">
                            <label for="jourId" class="form-label">JOUR<sup class="text-danger">*</sup> </label>
                            <select class="form-select form-select-lg" id="jourId">
                                <option hidden selected>Sélectionnez un jour...</option>
                            </select>
                        </div>
