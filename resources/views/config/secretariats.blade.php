...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <form method="post" action="{{route('config.create.secretariats')}}" class="card custom-card">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <input type="text" value="{{isset($secretariat) ? $secretariat->id : ''}}" hidden>
                        <div class="col-md-12 col-sm-12">
                            <label for="libelle" class="form-label">Libellé secrétariat<sup class="text-danger">*</sup> </label>
                            <input type="text" value="{{isset($secretariat) ? $secretariat->secretariat_libelle : ''}}" name="libelle" class="form-control" id="libelle" placeholder="Saisir le nom du ministère..." required>
                        </div>
                        <div class="col-md-12 col-sm-12 mt-2">
                            ...
                            <select name="ministere_id" id="ministere_id" class="form-select">
                                ...
                                @foreach($ministeres as $min)
                                    <option value="{{$min->id}}">{{$min->ministere_libelle}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-12 col-sm-12 mt-2">
                            ...
                            <textarea name="description" id="description" class="form-control" placeholder="Entrez une description...">
                                {{isset($secretariat) ?$secretariat->secretariat_description : ''}}
                            </textarea>
                        </div>
                    </div>
