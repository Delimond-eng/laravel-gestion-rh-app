            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Type_Conge</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12 col-sm-12">
                            <label for="TypeConge" class="form-label">Libelle Type conge<sup class="text-danger">*</sup> </label>
                            <input type="text" name="libelle" class="form-control" id="libelle" placeholder="Saisir le type du conge..." required>
                        </div>
                            ...
                            <table class="table text-nowrap table-sm">
                                ...
                                <tbody>
                                    @foreach(range(1, 26) as $iteration)
                                        <tr>
                                            <td>TypeCongé {{$iteration}}</td>
                                            <td>Description {{$iteration}}</td>
                                            <td>
